...
import { userLogin, userSigUp } from 'reducers/userSlice'
    ...
    return (
        <section className="min-w-screen min-h-screen bg-gray-900 flex items-center justify-center px-5 py-5">
            <form
                ...
                className="bg-gray-100 text-gray-500 rounded-3xl shadow-xl  overflow-hidden w-[80%]" >
                                ...
                                <div className="w-full px-3 mb-5">
                                    ...
                                    <div className="flex">
                                        ...
                                        <input
                                            onChange={formik.handleChange}
                                            name='name'
                                            type="text" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="johnsmith@example.com" />
                                    </div>
                                </div>
                            </div>
                            <div className="flex -mx-3">
